...
var ContractListComponent = (function () {
    function ContractListComponent(router, activatedRoute, contractsDataService, userProfileService, datepipe, dialogsService, changeDetectorRefs) {
        this.router = router;
    ...
    ContractListComponent.prototype.GoContractUpdate = function (e) {
...
var ContractNavMenuComponent = (function () {
    ...
    ContractNavMenuComponent.prototype.ngOnInit = function () {
        ...
        if (this.contractType === __WEBPACK_IMPORTED_MODULE_7__common_enums__["a" /* ContractType */].MGStatic) {
            ...
            this.contractDataService.getTemplateSteps(this.contractDataService.templateId).subscribe(function (templatesSteps) {
        ...
        this.contractNameDataService.contractName.subscribe(function (contractNameEntered) {
            _this.contractName = contractNameEntered;
        });
        this.contractUrlNotificationService.urlPath.subscribe(function (path) {
            ...
            if (_this.operation.trim().toLocaleLowerCase() === create &&
                _this.contractId === 0) {
    ...
    ContractNavMenuComponent.prototype.contractBasicDetails = function () {
        ...
        var contractBasicInfo = this.createContract.controls['contractNameEntered'].value +
            '~#' +
    ...
    ], ContractNavMenuComponent.prototype, "contractName", void 0);
...
var ContractTermsComponent = (function () {
    function ContractTermsComponent() {
    }
...
module.exports = "<div>\n  <app-contract-nav-menu [contractName] = \"contractName\"></app-contract-nav-menu>\n</div>\n<div >\n  <div class=\"body-style\">\n    <router-outlet></router-outlet>\n  </div>\n</div>\n"
...
var routes = [
    ...
    { path: 'redirect/:contractid', component: __WEBPACK_IMPORTED_MODULE_20__redirect_redirect_component__["a" /* RedirectComponent */] },
    {
        ...
        children: [
            ...
            { path: 'roomtype', component: __WEBPACK_IMPORTED_MODULE_10__rate_room_type_room_type_info_room_type_info_component__["a" /* RoomTypeInfoComponent */] },
...
var FacilitiesServicesComponent = (function () {
    function FacilitiesServicesComponent() {
    }
...
var HotelDetailsComponent = (function () {
    ...
    HotelDetailsComponent.prototype.ngOnInit = function () {
        ...
        if (this.contractType === this.mgStatic) {
            ...
            this.templatesDataService.getTemplateHotelFields(this.templateViewModel).subscribe(function (templateData) {
                _this.templateHotelInfoViewModel = templateData;
                _this.templateHotelInfoViewModel.hotelFields.forEach(function (hotelField) {
        ...
        this.filteredOptions = this.hotelDetailsContractGroup.get('hotelName').valueChanges
            .pipe(Object(__WEBPACK_IMPORTED_MODULE_7_rxjs_operators__["a" /* map */])(function (val) { return _this.filter(val); }));
    };
    /* ---------- Contact Details ---------------- */
    ...
    HotelDetailsComponent.prototype.searchHotel = function (event, hotelId) {
        ...
        if (event.source.selected) {
            this.hotelDataService.getHotel(hotelId).subscribe(function (hotelData) {
                ...
                if (_this.contactDetails.controls.length !== 0) {
                    _this.contactDetails.removeAt(1);
                }
                if (_this.taxDetails.controls.length !== 0) {
                    _this.taxDetails.removeAt(1);
                }
                if (_this.hotelData.hotelChainId != null) {
                    _this.getHotelBrands(_this.hotelData.hotelChainId);
                }
                if (_this.hotelData.countryId != null) {
                    _this.getCities(_this.hotelData.countryId);
                }
                _this.latLong = _this.hotelData.latitude + '/' + _this.hotelData.longitude;
                for (var i = 0; i < (_this.hotelData.contactDetails.length - 1); i++) {
                    _this.addContact();
                }
                for (var i = 0; i < _this.hotelData.contactDetails.length; i++) {
                    if (_this.hotelData.contactDetails[i].isPrimary === true) {
                        _this.rowSelected = i;
                    }
                }
                for (var i = 0; i < (_this.hotelData.taxDetails.length - 1); i++) {
                    _this.addTax();
                }
                _this.hotelDetailsContractGroup.get('hotelId').setValue(_this.hotelData.hotelId);
                _this.hotelDetailsContractGroup.get('hotelName').setValue(_this.hotelData.hotelName);
                _this.hotelDetailsContractGroup.get('hotelChainId').setValue(_this.hotelData.hotelChainId);
                _this.hotelDetailsContractGroup.get('hotelBrandId').setValue(_this.hotelData.hotelBrandId);
                _this.hotelDetailsContractGroup.get('hotelTypeId').setValue(_this.hotelData.hotelTypeId);
                _this.hotelDetailsContractGroup.get('countryId').setValue(_this.hotelData.countryId);
                _this.hotelDetailsContractGroup.get('cityId').setValue(_this.hotelData.cityId);
                _this.hotelDetailsContractGroup.get('address1').setValue(_this.hotelData.address1);
                _this.hotelDetailsContractGroup.get('address2').setValue(_this.hotelData.address2);
                _this.hotelDetailsContractGroup.get('zipCode').setValue(_this.hotelData.zipCode);
                _this.hotelDetailsContractGroup.get('latLong').setValue(_this.latLong);
                _this.hotelDetailsContractGroup.get('starRatingId').setValue(_this.hotelData.starRatingId);
                _this.hotelDetailsContractGroup.get('mgPoint').setValue(_this.hotelData.mgPoint);
                _this.hotelDetailsContractGroup.get('shortDescription').setValue(_this.hotelData.shortDescription);
                _this.hotelDetailsContractGroup.get('longDescription').setValue(_this.hotelData.longDescription);
                _this.hotelDetailsContractGroup.get('checkInFrom').setValue(_this.hotelData.checkInFrom);
                _this.hotelDetailsContractGroup.get('checkOutTo').setValue(_this.hotelData.checkOutTo);
                _this.hotelDetailsContractGroup.get('website').setValue(_this.hotelData.website);
                _this.hotelDetailsContractGroup.get('reservationEmail').setValue(_this.hotelData.reservationEmail);
                _this.hotelDetailsContractGroup.get('reservationContactNo').setValue(_this.hotelData.reservationContactNo);
                _this.hotelDetailsContractGroup.get('isExtranetAccess').setValue(_this.hotelData.isExtranetAccess);
                _this.hotelDetailsContractGroup.get('isChannelManagerConnectivity').setValue(_this.hotelData.isChannelManagerConnectivity);
                _this.hotelDetailsContractGroup.get('channelManagerId').setValue(_this.hotelData.channelManagerId);
                _this.contactDetails.controls.forEach(function (contact, index) {
                ...
                _this.hotelDetailsContractGroup.controls.hotelPaymentMethodRelation.get('paymentMethodId').
                    setValue(_this.hotelData.hotelPaymentMethodRelation.paymentMethodId);
                _this.hotelDetailsContractGroup.controls.hotelPaymentMethodRelation.get('currencyId').
                    setValue(_this.hotelData.hotelPaymentMethodRelation.currencyId);
                _this.hotelDetailsContractGroup.controls.hotelPaymentMethodRelation.get('rateTypeId').
                    setValue(_this.hotelData.hotelPaymentMethodRelation.rateTypeId);
                _this.taxDetails.controls.forEach(function (tax, index) {
    ...
    HotelDetailsComponent.prototype.saveContract = function () {
        var _this = this;
        var startDate = new Date(this.hotelDetailsContractGroup.get('startDate').value.trim());
        var endDate = new Date(this.hotelDetailsContractGroup.get('endDate').value.trim());
        if (this.contractType === this.nonMg) {
            this.contractHotelDetailsViewModel = {
                ...
                objectState: __WEBPACK_IMPORTED_MODULE_11__common_enums__["c" /* ObjectState */].Added,
            ...
            this.contractHotelDetailsDataService.addNonMgContract(this.contractHotelDetailsViewModel)
                ...
                _this.snackBar.open('NonMG Contract Saved Successfully', '', { duration: 8000, verticalPosition: 'top', panelClass: 'showSnackBar' });
                window.scrollTo(0, 0);
            });
        }
            ...
            this.contractHotelDetailsDataService.addDynamicContract(this.contractHotelDetailsViewModel)
                .subscribe(function (data) {
                _this.router.navigate(['/contractmgmt/contracts']);
                _this.snackBar.open('Dynamic Contract Saved Successfully', '', { duration: 8000, verticalPosition: 'top', panelClass: 'showSnackBar' });
                window.scrollTo(0, 0);
            });
        }
            ...
            this.hotelDataSave.objectState = __WEBPACK_IMPORTED_MODULE_11__common_enums__["c" /* ObjectState */].Added;
            ...
            this.hotelDataSave.contactDetails.forEach(function (contact, index) {
                ...
                contact.objectState = __WEBPACK_IMPORTED_MODULE_11__common_enums__["c" /* ObjectState */].Added;
            });
            this.hotelDataSave.hotelPaymentMethodRelation.objectState = __WEBPACK_IMPORTED_MODULE_11__common_enums__["c" /* ObjectState */].Added;
            this.hotelDataSave.taxDetails.forEach(function (tax) {
                tax.objectState = __WEBPACK_IMPORTED_MODULE_11__common_enums__["c" /* ObjectState */].Added;
            });
            ...
            this.contractHotelDetailsDataService.addStaticContract(this.staticContractHotelDetailsVieModel)
                .subscribe(function (data) {
                _this.router.navigate(['/contractmgmt/contracts']);
                _this.snackBar.open('Static Contract Saved Successfully', '', { duration: 8000, verticalPosition: 'top', panelClass: 'showSnackBar' });
                window.scrollTo(0, 0);
            });
        }
    };
...
var RoomTypeInfoComponent = (function () {
    function RoomTypeInfoComponent() {
    }
...
var RoomTypeListComponent = (function () {
    function RoomTypeListComponent() {
    }
